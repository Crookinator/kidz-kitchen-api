...
This template contains a project, `kidz-kitchen`, and an app, `api`,
...
1. Replace all instances of `kidz-kitchen` with your application name. **This includes the folder included in this repository.**
...
This template includes a project `kidz-kitchen` which should be renamed
...
all instances of `kidz-kitchen` with your app's name.
